    ...
    <div class="container">
      <form @submit.prevent="adicionarPessoa" class="form">
        ...
        <div class="form-group">
          ...
          <input type="text" id="rg" v-model="pessoa.rg" v-mask="'##.###.###-#'" required class="form-control" />
        </div>
        <div class="form-group">
          <label for="cpf">CPF:</label>
          <input type="text" id="cpf" v-model="pessoa.cpf" v-mask="'###.###.###-##'" required class="form-control" />
        </div>
        <div class="form-group">
          <label for="data_nascimento">Data de Nascimento:</label>
          <input type="text" id="data_nascimento" v-model="pessoa.data_nascimento" v-mask="'##/##/####'" required
            class="form-control" />
        </div>
        <div class="form-group">
          <label for="dataAdmissao">Data de Admissão:</label>
          <input type="text" id="dataAdmissao" v-model="pessoa.data_admissao" v-mask="'##/##/####'" required
            class="form-control" />
        </div>
        <div class="form-group">
